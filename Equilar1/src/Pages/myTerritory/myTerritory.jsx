...
import styles from './myTerritory.module.css';
  ...
  <div className={styles["main-wrapper"]}>
    <div className={styles["main-container"]}>
      <div className={styles["header-row"]}>
        <h2 className={styles["update-heading"]}>My Territory</h2>
        ...
        <div className={styles["all-updates-container"]}>
          {territoryData.map((company, index) => (
            <div key={index}>
              ...
              {index < territoryData.length - 1 && <hr className={styles["company-divider"]} />}
            </div>
          ))}
        </div>
      </div>
